...
DO $EF$
BEGIN
    IF EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260630163409_DeferDeleteChecksForEntitiesThatCanOnlyBeDeletedTogether') THEN
...
BEGIN
    ...
    WHERE "MigrationId" = '20260630163409_DeferDeleteChecksForEntitiesThatCanOnlyBeDeletedTogether';
    END IF;
END $EF$;
COMMIT;
