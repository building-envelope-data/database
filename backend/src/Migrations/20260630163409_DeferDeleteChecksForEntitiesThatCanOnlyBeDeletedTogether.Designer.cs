...
namespace Database.Migrations
{
    ...
    [Migration("20260630163409_DeferDeleteChecksForEntitiesThatCanOnlyBeDeletedTogether")]
    partial class DeferDeleteChecksForEntitiesThatCanOnlyBeDeletedTogether
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "database", "optical_component_subtype", new[] { "acid_etched_glass", "applied_film", "cellular_shade", "chromogenic", "coated", "coating", "diffusing_shade", "embedded_coating", "film", "fritted_glass", "interlayer", "laminate", "monolithic", "perforated_screen", "pleated_shade", "roller_shade", "roman_shade", "sandblasted_glass", "shade_material", "solar_screen", "venetian_blind", "vertical_louver", "woven_shade" });
                    ...
                    b.ToTable("get_https_resource", "database", t =>
                        {
                            ...
                            t.HasTrigger("LC_TRIGGER_resource_root_can_only_deleted_alongside_its_data");

                            t.HasTrigger("get_https_resource_data_id_cannot_change");

                            t.HasTrigger("get_https_resource_data_ids_must_match");

                            t.HasTrigger("resource_root_can_only_deleted_alongside_its_data");
