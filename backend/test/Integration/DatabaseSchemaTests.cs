    ...
    : IntegrationTests
{
    ...
    /// ```
    /// liquibase diff \
    ///    --url="jdbc:postgresql://database:5432/xbase" --username="postgres" --password="postgres" --default-schema-name="database" \
    ///    --reference-url="jdbc:postgresql://database:5432/test" --reference-username="postgres" --reference-password="postgres" --reference-default-schema-name="database"
    /// ```
